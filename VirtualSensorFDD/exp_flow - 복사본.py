...
data = pd.read_csv(r'C:\Users\user\OneDrive - Chonnam National University\학석사 연계과정\코드\FDD python\samsung\Experiment\Data\2022-{}-{}\{}{} flow.csv'.format(month,day,month,day),engine='python')
...
# statistics.mean(velocity4), statistics.mean(velocity5), statistics.mean(velocity6),
...
print(statistics.mean([statistics.mean(velocity1),statistics.mean(velocity2),statistics.mean(velocity3),]))
                       ...
                       # statistics.mean(power4), statistics.mean(power5),statistics.mean(power6),
...
ax1[2].set_xticks([0,10,20,30,40])
...
# ax1[0, 3].plot(range(len(x4)), velocity4, color='b', linewidth=1.5,linestyle='-')
# ax1[0, 3].set_xticks([0,10,20,30,40])
# ax1[0, 3].set_xticklabels([x4[0],x4[10],x4[20],x4[30]])
# ax2 = ax1[0, 3].twinx()
...
# ax2.set_ylabel('Fan step [step]', fontsize=14)
#
# ax1[1,0].plot(range(len(x5)), velocity5, color='b', linewidth=1.5,linestyle='-')
# ax1[1,0].set_xticks([0,10,20,30,40,])
# ax1[1,0].set_xticklabels([x5[0],x5[10],x5[20],x5[30]])
# ax2 = ax1[1,0].twinx()
# ax2.plot(range(len(x5)), power5,color='gray', linewidth=1.5, linestyle='--')
# # ax2.set_yticks([0,5000,10000,15000,20000,25000,30000,35000,40000])
# ax2.set_yticks([0,10,20,30,40,50])
#
# ax1[1, 1].plot(range(len(x6)), velocity6, color='b', linewidth=1.5,linestyle='-')
# ax1[1, 1].set_xticks([0,10,20,30,40,])
# ax1[1, 1].set_xticklabels([x6[0],x6[10],x6[18],x6[30]])
# ax2 = ax1[1, 1].twinx()
