...
overall = pd.concat([y1,y2,y3,],axis=1).to_csv('./temp_resample_upper.csv')

# ,statistics.mean(y4),statistics.mean(y5),statistics.mean(y6),statistics.mean(y7),statistics.mean(y8),statistics.mean(y9),statistics.mean(y10)
#                        statistics.mean(y11),statistics.mean(y12),statistics.mean(y13)
# print(statistics.mean([statistics.mean(y1),statistics.mean(y2),statistics.mean(y3)
#                        ]))
